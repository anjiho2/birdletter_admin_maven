...
function fn_search(val) {
	...
	itemService.nestItemBuyLogListCnt(userName, phoneNumber, startDate, endDate, function(cnt) {
		if (cnt == "0") {
		...
		itemService.nestItemBuyLogList(sPage, pagingCnt, userName, phoneNumber, startDate, endDate, function(selList) {
			if (selList.length > 0) {
...
function nestItemUseExcelDownload() {
	var searchType = getSelectboxValue("sel_searchType");
	var searchValue = getInputTextValue("search_value");
	...
	if (confirm(comment.isExcelDownload)) {
		...
		form_submit("frm", "excel/nestItemUseList.do");
	}
}
</script>
	...
	<div class="subbody">
		<div class="row-fluid">
			<div class="breadcrumb span10">
				<span class="">아이템</span>&nbsp;〉&nbsp;<span onclick="javascript:goItem('nestItemBuyLogList');">둥지 아이템 구매 내역</span>
			</div>
			<div class="span10">
				...
				<div class="content">
					<div class="portlet">
						<div class="portlet-header anthracite-gradient">
							<span class="icon_id"></span><span>둥지 아이템 구매 내역</span>
						</div>
							...
							<div class="content">
								<div class="list_top">
									...
									<p class="f_R">
										...
										<a href="javascript:nestItemUseExcelDownload();" class="button compact black-gradient glossy">
...
<script>
$("#menu_03_10").addClass("active");</script>