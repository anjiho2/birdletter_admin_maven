...
<!-- 년도, 몇주차인지로 월요일 날짜와 토요일 날짜 가져오는 스크립트 -->
...
function fn_search(val) {
	...
	letterTypeSelectBox("l_letter", "private");
	...
	statisticsService.userMessageSendStatisticsCnt(startDate, endDate, userName, selectGender, function(cnt) {
		if (cnt == "0") {
		...
		statisticsService.userMessageSendStatistics(sPage, startDate, endDate, userName, selectGender, function(selList) {
			if (selList.length > 0) {
...
function chart() {
	...
	statisticsService.userMessageSendStatistics(0, startDate, endDate, userName, "", function(selList) {
		if (selList != null) {
...
function dailyStats() {
	...
	statisticsService.userMessageSendByDailyStats(searchDate, "PRIVATE", function(selList) {
		$("#container2").show();
		if (selList.length > 0) {
...
function weekStats() {
	...
	statisticsService.userMessageSendByWeekStats(startWeek, endWeek, "PRIVATE", function(selList) {
		$("#container3").show();
