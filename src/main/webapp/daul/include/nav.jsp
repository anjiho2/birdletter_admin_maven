				...
				<ul class="nav nav-list">
					...
					<li class="sub">
						...
						<ul>
							...
							<li id="menu_03_05"><a href="javascript:goItem('cornInfoList');"><span class="arrow_triangle-right"></span>콘/팝콘 판매 정보</a></li>
							...
							<li id="menu_03_09"><a href="javascript:goItem('gatchaUseLogList');"><span class="arrow_triangle-right"></span>가차 사용 내역</a></li>
							<li id="menu_03_10"><a href="javascript:goItem('nestItemBuyLogList');"><span class="arrow_triangle-right"></span>둥지 아이템 구매 내역</a></li>
						</ul>
					</li>
					<li class="sub">
					...
					<li class="sub">
						...
						<ul>
							...
							<li id="menu_07_03"><a href="javascript:goPush('pushSend')"><span class="arrow_triangle-right"></span>푸시 알림 발송</a></li>
						</ul>
					</li>
					<!-- 
					<li class="sub">
